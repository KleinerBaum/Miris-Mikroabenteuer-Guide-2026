...
- Die Widget-State-Synchronisierung zwischen Sidebar und Formular erfolgt jetzt kollisionssicher über Initialwerte + `on_change`-Callbacks statt direkter Überschreibungen gebundener Keys; Submit nutzt einen kontrollierten Re-Run mit `criteria_updated`-Flag.
